...
Commands: 
        - synctableinfo tableinfo:*${modality}_*ImageTable false true
        - synctableinfo tableinfo:*${modality}_*SeriesTable false true
        - synctableinfo tableinfo:*${modality}_*StudyTable false true
