...
| HIC.RDMP.Dicom | [GitHub](https://github.com/HicServices/RdmpDicom) | [1.1.0](https://www.nuget.org/packages/HIC.RDMP.Dicom/1.1.0) | [GPL 3.0](https://www.gnu.org/licenses/gpl-3.0.html) | RDMP Plugin containing data load / pipeline components for imaging, reading dicom files etc | |
