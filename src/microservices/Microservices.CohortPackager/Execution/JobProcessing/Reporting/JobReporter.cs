...
namespace Microservices.CohortPackager.Execution.JobProcessing.Reporting
{
    public class JobReporter : IJobReporter
    {
        ...
        // NOTE(rkm 2022-09-02) Currently unused until IsIdentifiable supports passing it to CsvDestination
        ...
        private void WriteVerificationFailuresCsv(CompletedExtractJobInfo jobInfo, string jobReportsDirAbsolute)
        {
            ...
            // TODO(rkm 2022-09-02) Add IFileSystem overload
            using var csvDest = new CsvDestination(isIdentOptions, verificationFailuresReportName, addTimestampToFilename: false);
