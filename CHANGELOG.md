...
- Added `ExtractionName` to the extraction messages, which tracks the name of the input file in order to build the output paths. Fixes [MVP Service #159](https://dev.azure.com/smiops/MVP%20Service/_workitems/edit/159/)
