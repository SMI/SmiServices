...
public sealed class TestData
{
    ...
    public string IMG_013 = Path.Combine(TEST_DATA_DIR, "IM-0001-0013.dcm");
    public string IMG_019 = Path.Combine(TEST_DATA_DIR, "IM-0001-0019.dcm");
    public string IMG_024 = Path.Combine(TEST_DATA_DIR, "IM-0001-0024.dcm");
    public string MANY_TAGS = Path.Combine(TEST_DATA_DIR, "FileWithLotsOfTags.dcm");
    public string INVALID_DICOM = Path.Combine(TEST_DATA_DIR, "NotADicomFile.txt");
    public string BURNED_IN_TEXT_IMG = Path.Combine(TEST_DATA_DIR, "burned-in-text-test.dcm");
    ...
    /// <returns></returns>
    public FileInfo Create(FileInfo fileInfo, string? testFile = null)
    {
