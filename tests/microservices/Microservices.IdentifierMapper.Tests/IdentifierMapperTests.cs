...
namespace Microservices.IdentifierMapper.Tests
{
    ...
    public class IdentifierMapperTests : DatabaseTests
    {
        ...
        public void TestIdentifierSwap2ForGuids(DatabaseType dbType)
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(swapper.GetSubstitutionFor("01010101", out _), Has.Length.EqualTo(36));
                Assert.That(swapper.GetSubstitutionFor("02020202", out _), Has.Length.EqualTo(36));
